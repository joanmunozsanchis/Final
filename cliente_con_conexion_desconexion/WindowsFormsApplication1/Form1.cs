...
namespace WindowsFormsApplication1
{
    ...
    {
        Socket server;
        Socket server2; //Ya que disponemos de dos servidores
        public Form1()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            IPAddress direc2 = IPAddress.Parse("192.168.56.102");
            IPEndPoint ipep2 = new IPEndPoint(direc2, 9300);
            ...
            try
            {
                server2.Connect(ipep2);//Intentamos conectar el socket
                this.BackColor = Color.Green;
                MessageBox.Show("Conectado");
